...
namespace MesWeb.DALFactory
{
    ...
    public sealed class DataAccess
    {
        ...
        public static MesWeb.IDAL.ISpecification CreateSpecification()
        {

            string ClassNamespace = AssemblyPath + ".Specification";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (MesWeb.IDAL.ISpecification)objType;
        ...
        /// 创建Procedure数据层接口。
        /// </summary>
        public static MesWeb.IDAL.IProcedure CreateProcedure()
        {

            string ClassNamespace = AssemblyPath + ".Procedure";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (MesWeb.IDAL.IProcedure)objType;
        }
        ...
        /// 创建ProductType数据层接口。
        /// </summary>
        public static MesWeb.IDAL.IProductType CreateProductType()
        {

            string ClassNamespace = AssemblyPath + ".ProductType";
            object objType = CreateObject(AssemblyPath, ClassNamespace);
            return (MesWeb.IDAL.IProductType)objType;
        }
    }
}
...
namespace MesWeb.BLL
{
	...
	{
		private readonly IT_Report_Header dal=DataAccess.CreateT_Report_Header();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MesWeb.Model.T_Report_Header GetModelByCache(int Id)
		{
			
			string CacheKey = "T_Report_HeaderModel-" + Id;
			...
			return (MesWeb.Model.T_Report_Header)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Report_Header> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Report_Header> DataTableToList(DataTable dt)
		{
			List<MesWeb.Model.T_Report_Header> modelList = new List<MesWeb.Model.T_Report_Header>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MesWeb.Model.T_Report_Header model;

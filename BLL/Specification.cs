...
namespace MesWeb.BLL
{
	...
	{
		private readonly ISpecification dal=DataAccess.CreateSpecification();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MesWeb.Model.Specification GetModelByCache(int id)
		{
			
			string CacheKey = "SpecificationModel-" + id;
			...
			return (MesWeb.Model.Specification)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.Specification> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.Specification> DataTableToList(DataTable dt)
		{
			List<MesWeb.Model.Specification> modelList = new List<MesWeb.Model.Specification>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MesWeb.Model.Specification model;

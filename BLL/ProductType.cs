...
namespace MesWeb.BLL
{
	...
	public partial class ProductType
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MesWeb.Model.ProductType GetModelByCache(int id)
		{
			...
			return (MesWeb.Model.ProductType)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.ProductType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.ProductType> DataTableToList(DataTable dt)
		{
			List<MesWeb.Model.ProductType> modelList = new List<MesWeb.Model.ProductType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MesWeb.Model.ProductType model;

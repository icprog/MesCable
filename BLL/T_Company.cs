...
namespace MesWeb.BLL
{
	...
	public partial class T_Company
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MesWeb.Model.T_Company GetModelByCache(int CompanyID)
		{
			...
			return (MesWeb.Model.T_Company)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Company> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Company> DataTableToList(DataTable dt)
		{
			List<MesWeb.Model.T_Company> modelList = new List<MesWeb.Model.T_Company>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MesWeb.Model.T_Company model;

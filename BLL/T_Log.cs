...
namespace MesWeb.BLL
{
	...
	public partial class T_Log
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MesWeb.Model.T_Log GetModelByCache(int LogID)
		{
			
			string CacheKey = "T_LogModel-" + LogID;
			...
			return (MesWeb.Model.T_Log)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Log> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Log> DataTableToList(DataTable dt)
		{
			List<MesWeb.Model.T_Log> modelList = new List<MesWeb.Model.T_Log>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MesWeb.Model.T_Log model;

...
namespace MesWeb.BLL
{
	...
	public partial class T_User
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MesWeb.Model.T_User GetModelByCache(int UserID)
		{
			...
			return (MesWeb.Model.T_User)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_User> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_User> DataTableToList(DataTable dt)
		{
			List<MesWeb.Model.T_User> modelList = new List<MesWeb.Model.T_User>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MesWeb.Model.T_User model;

...
namespace MesWeb.BLL
{
	...
	{
		private readonly IT_Product dal=DataAccess.CreateT_Product();
		public T_Product()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MesWeb.Model.T_Product GetModelByCache(int ProductID)
		{
			
			string CacheKey = "T_ProductModel-" + ProductID;
			...
			return (MesWeb.Model.T_Product)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Product> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Product> DataTableToList(DataTable dt)
		{
			List<MesWeb.Model.T_Product> modelList = new List<MesWeb.Model.T_Product>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MesWeb.Model.T_Product model;

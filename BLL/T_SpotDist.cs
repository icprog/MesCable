...
namespace MesWeb.BLL {
    ...
    public partial class T_SpotDist {
        private readonly IT_SpotDist dal = DataAccess.CreateT_SpotDist();
        public T_SpotDist() { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public MesWeb.Model.T_SpotDist GetModelByCache(int Id) {

            string CacheKey = "T_SpotDistModel-" + Id;
            ...
            return (MesWeb.Model.T_SpotDist)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<MesWeb.Model.T_SpotDist> GetModelList(string strWhere) {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MesWeb.Model.T_SpotDist> DataTableToList(DataTable dt) {
            List<MesWeb.Model.T_SpotDist> modelList = new List<MesWeb.Model.T_SpotDist>();
            int rowsCount = dt.Rows.Count;
            if(rowsCount > 0) {
                MesWeb.Model.T_SpotDist model;

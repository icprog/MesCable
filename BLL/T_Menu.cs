...
namespace MesWeb.BLL
{
	...
	public partial class T_Menu
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MesWeb.Model.T_Menu GetModelByCache(int MenuID)
		{
			
			string CacheKey = "T_MenuModel-" + MenuID;
			...
			return (MesWeb.Model.T_Menu)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Menu> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Menu> DataTableToList(DataTable dt)
		{
			List<MesWeb.Model.T_Menu> modelList = new List<MesWeb.Model.T_Menu>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MesWeb.Model.T_Menu model;

...
namespace MesWeb.BLL
{
	...
	{
		private readonly IT_Report_Footer dal=DataAccess.CreateT_Report_Footer();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MesWeb.Model.T_Report_Footer GetModelByCache(int Id)
		{
			
			string CacheKey = "T_Report_FooterModel-" + Id;
			...
			return (MesWeb.Model.T_Report_Footer)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Report_Footer> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MesWeb.Model.T_Report_Footer> DataTableToList(DataTable dt)
		{
			List<MesWeb.Model.T_Report_Footer> modelList = new List<MesWeb.Model.T_Report_Footer>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MesWeb.Model.T_Report_Footer model;

...
namespace MesWeb.BLL {
    ...
    public partial class Sys_App {
        private readonly ISys_App dal = DataAccess.CreateSys_App();
        public Sys_App() { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public MesWeb.Model.Sys_App GetModelByCache(int id) {
            ...
            return (MesWeb.Model.Sys_App)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<MesWeb.Model.Sys_App> GetModelList(string strWhere) {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MesWeb.Model.Sys_App> DataTableToList(DataTable dt) {
            List<MesWeb.Model.Sys_App> modelList = new List<MesWeb.Model.Sys_App>();
            int rowsCount = dt.Rows.Count;
            if(rowsCount > 0) {
                MesWeb.Model.Sys_App model;

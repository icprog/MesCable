...
namespace MesWeb.BLL {
    ...
    public partial class T_SpotInfo {
        private readonly IT_SpotInfo dal = DataAccess.CreateT_SpotInfo();
        public T_SpotInfo() { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public MesWeb.Model.T_SpotInfo GetModelByCache(int Id) {

            string CacheKey = "T_SpotInfoModel-" + Id;
            ...
            return (MesWeb.Model.T_SpotInfo)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<MesWeb.Model.T_SpotInfo> GetModelList(string strWhere) {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MesWeb.Model.T_SpotInfo> DataTableToList(DataTable dt) {
            List<MesWeb.Model.T_SpotInfo> modelList = new List<MesWeb.Model.T_SpotInfo>();
            int rowsCount = dt.Rows.Count;
            if(rowsCount > 0) {
                MesWeb.Model.T_SpotInfo model;

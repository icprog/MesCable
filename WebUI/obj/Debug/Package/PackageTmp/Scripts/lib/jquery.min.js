...
jQuery.fn.deserializeForm = function (data) {
...
jQuery.fn.isNullOrEmpty = function (str) {
...
jQuery.fn.serializeForm = function () {
    ...
    $form.find("option").each(function (i, v) {
...
if (typeof (RESULT_CODE) == "undefined") {
    var RESULT_CODE = {
        OK: 0,
        ERROR: 1
    };

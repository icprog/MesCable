...
(function ($w) {
    ...
    var jm = function (options) {
        ...
        //add extend debug option to determin disable the log info of console
    ...
    jm.prototype = {
        ...
        dblclick_handle: function (e) {
            ...
            /// <summary>
            /// extend method when double click one node then get the node info
            /// </summary>
            ...
            if (typeof this.options.dblclickNode == "function") {
                var element = e.target || event.srcElement;
                var nodeid = this.view.get_binded_nodeid(element);
                if (!!nodeid) {
                    this.options.dblclickNode(this.get_selected_node());
                }
            }

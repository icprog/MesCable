...
namespace MesWeb.SQLServerDAL
{
	...
	/// 数据访问类:T_PARCODE
	/// </summary>
	public partial class T_PARCODE:IT_PARCODE
	{
		public T_PARCODE()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ParameterCodeID", "T_PARCODE"); 
		}
		...
		public bool Exists(int ParameterCodeID)
		{
			...
			strSql.Append("select count(1) from T_PARCODE");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MesWeb.Model.T_PARCODE model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_PARCODE(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MesWeb.Model.T_PARCODE model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_PARCODE set ");
		...
		public bool Delete(int ParameterCodeID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_PARCODE ");
			strSql.Append(" where ParameterCodeID=@ParameterCodeID");
			SqlParameter[] parameters = {
					new SqlParameter("@ParameterCodeID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MesWeb.Model.T_PARCODE GetModel(int ParameterCodeID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ParameterCodeID,ParameterCode,ParameterType,ParameterName,ParameterUnitID,ParameterBit,type from T_PARCODE ");
			strSql.Append(" where ParameterCodeID=@ParameterCodeID");
			SqlParameter[] parameters = {
					new SqlParameter("@ParameterCodeID", SqlDbType.Int,4)
			};
			...
			MesWeb.Model.T_PARCODE model=new MesWeb.Model.T_PARCODE();
		...
		/// 得到一个对象实体
		/// </summary>
		public MesWeb.Model.T_PARCODE DataRowToModel(DataRow row)
		{
			MesWeb.Model.T_PARCODE model=new MesWeb.Model.T_PARCODE();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_PARCODE T ");

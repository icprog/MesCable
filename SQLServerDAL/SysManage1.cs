...
namespace MesWeb.SQLServerDAL
{
    ...
    public class SysManage1 : ISysManage//这里必须实现接口，否则工厂类创建接口报错
	{
        ...
        public int AddTreeNode(MesWeb.Model.SysNode model)
		{
        ...
        public void UpdateNode(MesWeb.Model.SysNode model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// <returns></returns>
        public MesWeb.Model.SysNode GetNode(int NodeID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from S_Tree ");	
			strSql.Append(" where NodeID=@NodeID");
            ...
            MesWeb.Model.SysNode node = new MesWeb.Model.SysNode();

...
namespace MesWeb.SQLServerDAL
{
	...
	/// 数据访问类:T_Employee
	/// </summary>
	public partial class T_Employee:IT_Employee
	{
		public T_Employee()
		{}
		#region  BasicMethod
		...
		public MesWeb.Model.T_Employee GetModel(long EmployeeID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 EmployeeID,DepartmentID,EmployeeName,EmployeeCode,EmployeeSex,EmployeeAge,EmployeeTel,DutyID,GeneratorTime,isDeleted from T_Employee ");
			strSql.Append(" where EmployeeID=@EmployeeID");
			SqlParameter[] parameters = {
					new SqlParameter("@EmployeeID", SqlDbType.BigInt)
			};
			...
			MesWeb.Model.T_Employee model=new MesWeb.Model.T_Employee();
		...
		/// 得到一个对象实体
		/// </summary>
		public MesWeb.Model.T_Employee DataRowToModel(DataRow row)
		{
			MesWeb.Model.T_Employee model=new MesWeb.Model.T_Employee();
			if (row != null)
			{
